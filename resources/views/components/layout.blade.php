...
<main class="w-full">
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <x-navigation.nav-link href="/" :current="false">
                                    Home
                                </x-navigation.nav-link>
                                <x-navigation.nav-link href="/latest-movies" :current="true">
                                    Latest Movies
                                </x-navigation.nav-link>
        ...
        <main>
            <div class="mx-auto bg-white  max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                {{ $slot }}
            </div>
        </main>
    </div>
